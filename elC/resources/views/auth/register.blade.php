...
<div class="container">
 ...
 <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="specialite" type="specialite" class="form-control @error('specialite') is-invalid @enderror" name="specialite" value="{{ old('specialite') }}" required autocomplete="specialite">
