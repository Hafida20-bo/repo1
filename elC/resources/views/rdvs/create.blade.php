     ...
     <div class="row">
        ...
        <div class="col-xs-12 col-sm-12 col-md-12">
            <div class="form-group">
                ...
                <input type="datetime-local" name="date_debut" class="form-control" placeholder="Enter Title">
            </div>
        </div>
        <div class="col-xs-12 col-sm-12 col-md-12">
            <div class="form-group">
                <strong>Date De Fin*</strong>
                <input type="datetime-local" name="date_fin" class="form-control" placeholder="Enter Title">
            </div>
        </div>
        <div class="col-xs-12 col-sm-12 col-md-12">
            <div class="form-group">
                <strong>Motif*</strong>
                <input type="text" name="motif" class="form-control" placeholder="Enter Title">
            </div>
        </div>
